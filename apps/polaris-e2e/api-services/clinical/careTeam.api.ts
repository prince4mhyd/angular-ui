...
//     public static async getSticky({ patientId, auth = true }: IGetByPatientId): Promise<string> {
//         console.log(patientId + '  ' + auth);
//         response = await superAgent.get('https://localhost:1405/patients/98/care-team');
//         // const response = await RequestBuilder.clinicalApi(auth).get(`/patients/${patientId}/sticky-notes`);
//         console.log(response);
//         return response.text;
//     }
// }

// interface IGetByPatientId {
//     patientId: string;
//     auth?: boolean;
// }
